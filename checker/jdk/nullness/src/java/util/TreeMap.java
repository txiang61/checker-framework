...
// This class permits null keys when using a custom comparator that allows null.
public class TreeMap<K extends @NonNull Object, V extends @Nullable Object> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, java.io.Serializable {
  ...
  @Pure public @Nullable V get(@NonNull Object a1) { throw new RuntimeException("skeleton method"); }
