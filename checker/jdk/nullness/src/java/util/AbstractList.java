...
public abstract class AbstractList<E extends @Nullable Object> extends AbstractCollection<E> implements List<E> {
  ...
  @Pure public int indexOf(@NonNull Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public int lastIndexOf(@NonNull Object a1) { throw new RuntimeException("skeleton method"); }
